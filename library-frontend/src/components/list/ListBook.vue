<template>
  <div class="accordion-item" v-for="(element, index) in list" :key="element._id" @click="updateActiveIndex(index)">
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <EditBook :book="book" v-if="book && book._id" @send:book="sendBook" />
        </div>
      </div>
    </div>
  </div>
...
<script>
import EditBook from '../edit/EditBook.vue';
export default {
  components: {
    EditBook,
  },
