...
<template>
    <Form :validation-schema="contactFormSchema" @submit="updatetBook" class="row g-3">
        ...
        <div class="col-md-6">
            ...
            <Field type="text" class="form-control" name="hinhAnh" placeholder="..." v-model="book.hinhAnh" />
            <ErrorMessage name="hinhAnh" class="text-danger" />
            <img v-if="book.hinhAnh" :src="book.hinhAnh" class="img-thumbnail mt-2" style="max-width: 150px;">
        </div>
        <div class="col-md-3">
            <label for="number" class="form-label">Số quyển</label>
            <Field type="number" class="form-control" name="number" v-model="book.soquyenSach" />
