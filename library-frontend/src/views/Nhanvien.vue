<template>
        ...
        <img src="https://i.postimg.cc/7PCN37yM/logo.jpg" width="100" style="border-radius: 50px;">
                ...
                <ul>
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                            <li><a class="dropdown-item btn btn-primary" data-bs-toggle="modal" :data-bs-target="'#profileModal' + this.user._id">Thông tin nhân viên</a></li>
        ...
        <div class="col-3 px-2 bg-dark-subtle ">
            <div id="sidebar" class="collapse collapse-horizontal show border-end bg-secondary-subtle" >
                <div id="sidebar-nav" class="list-group border-0 rounded-0 text-sm-start min-vh-100 ">
                    ...
                    <a href="#" class="list-group-item border-end-0 rounded-3 mt-2 d-inline-block text-truncate bg-white" @click="pick_nav=11" v-if="user.chucvuNV === 'admin'"><span>Xem thông tin nhân viên</span> </a>
                    ...
                    <a href="#" class="list-group-item border-end-0 rounded-3 mt-2 d-inline-block text-truncate bg-white" @click="pick_nav=10" v-if="user.chucvuNV === 'admin'"><span>Thêm nhân viên</span> </a>
                </div>
            </div>
        </div>
