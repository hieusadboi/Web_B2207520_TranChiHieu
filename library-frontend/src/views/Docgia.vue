  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse " id="navbarSupportedContent">
      ...
      <ul class="navbar-nav ms-auto mb-2 mb-lg-0 ">
        <li class="nav-item" >
          <a class="nav-link d-flex flex-column text-center active" aria-current="page" href="#" @click="nav_pick = 0, updateSach"><i class="fas fa-home fa-lg my-2"></i><span class="small">Trang chủ</span></a>
        </li>
        <li class="nav-item" >
          <a class="nav-link d-flex flex-column text-center active" aria-current="page" href="#" @click="nav_pick = 1, updateList_y"><i class="fa-solid fa-paper-plane"></i><span class="small">Yêu cầu mượn sách</span></a>
        </li>
        <li class="nav-item">
          <a class="nav-link d-flex flex-column text-center" aria-current="page" href="#" @click="nav_pick = 2, updateList_m"><i class="fa-solid fa-book"></i><span class="small">Xem số sách đang mượn</span></a>
        </li>

        <li class="nav-item">
          <a class="nav-link d-flex flex-column text-center" aria-current="page" href="#" @click="nav_pick = 3, updateList_t"><i class="fa-solid fa-clock"></i><span class="small">Lịch sử mượng sách</span></a>
        </li>
        <!-- Dropdown -->
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
            <li><a class="dropdown-item btn btn-primary" data-bs-toggle="modal" :data-bs-target="'#profileModal'+ user._id">Thông tin đọc giả</a></li>
